...
const audioBoutonValide    = new Audio('./audio/clavier.mp3')
const audioBoutonNonValide = new Audio('./audio/sonnerie.mp3')
const audioFelicitation    = new Audio('./audio/plante.mp3')
const audioDommage         = new Audio('./audio/clavier.mp3')
